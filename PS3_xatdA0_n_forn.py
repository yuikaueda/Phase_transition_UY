...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 22 14:16:34 2024
...
for i, n in enumerate(n_values):
    plt.plot(c_values, min_x_values_all_n[i], color=colors[i], label=f'$n_{3}$ = {n}')  
...
fig.set_dpi(300)  
plt.legend()
plt.savefig('PS3_x0forN_suchi.png', bbox_inches="tight", pad_inches=0.05, dpi=300)  
plt.show()